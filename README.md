# COURTYARD
Hack and slash shootem action adventure games are a lot of fun! Hence, this repository is dedicated to experimentation with their game mechanics.
...
- Create additional surrounding (non-traversible) environment: i.e. Mountains, Trees, Road
