...
func _update_animation(delta):
	...
	if is_on_floor() and not hvel:
		...
		pass
	#elif is_on_floor() and hvel >= 4.5:
		## Character running
		#time_scale = clamp(remap(hvel, 4.5, 5, 1.1, 1.4), 1.1, 1.4)
		...
		#pass
	#elif is_on_floor() and hvel >= 2.0:
		## Character walking
		#blend_amount = clamp(remap(hvel, 2, 4.5, 0.4, 0.999), 0.4, 0.999)
		#time_scale = clamp(remap(hvel, 2, 4.5, 0.9, 1.1), 0.9, 1.1)
		#anim_tree.set("parameters/BlendIdleWalkRun/blend_amount", 1)
		#anim_tree.set("parameters/BlendGroundAir/blend_amount", 0)
		#anim_tree.set("parameters/BlendWalkRun/blend_amount", blend_amount)
		#anim_tree.set("parameters/WalkTimeScale/scale", time_scale)
		#anim_tree.set("parameters/RunTimeScale/scale", time_scale)
		#pass
	#elif is_on_floor() and hvel >= 1.0:
		## Character walking
		#blend_amount = clamp(remap(hvel, 1, 2, 0.001, 0.4), 0.001, 0.4)
		#time_scale = clamp(remap(hvel, 1, 2, 0.7, 0.9), 0.7, 0.9)
		#anim_tree.set("parameters/BlendIdleWalkRun/blend_amount", 1)
		#anim_tree.set("parameters/BlendGroundAir/blend_amount", 0)
		#anim_tree.set("parameters/BlendWalkRun/blend_amount", blend_amount)
		#anim_tree.set("parameters/WalkTimeScale/scale", time_scale)
	...
	#elif is_on_floor():
		## Character walking
		#blend_amount = clamp(remap(hvel, 0, 3, -0.8, 0), -1, 0)
		#time_scale = clamp(remap(hvel, 0, 1, 0, 0.7), 0, 0.7)
		#anim_tree.set("parameters/BlendIdleWalkRun/blend_amount", 0.8)
		#anim_tree.set("parameters/BlendGroundAir/blend_amount", 0)
		#anim_tree.set("parameters/BlendWalkRun/blend_amount", 0.001)
		#anim_tree.set("parameters/TimeScale/scale", time_scale)
		#anim_tree.set("parameters/WalkTimeScale/scale", time_scale)
		#anim_tree.set("parameters/RunTimeScale/scale", time_scale)
		#pass
	elif is_on_floor():
